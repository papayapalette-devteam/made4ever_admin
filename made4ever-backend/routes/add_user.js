...
const { saveAcceptedProfile, getAcceptedProfiles, deleteAcceptedProfile,ApprovedacceptMatch, rejectMatch, getMatchesByProfile } = require('../controllers/AcceptMatches/accept_matches');
...
router.get("/getmatch-byprofile/:id",getMatchesByProfile);

router.put("/approved-acceptprofile/:id",ApprovedacceptMatch);

router.put("/reject-acceptprofile/:id",rejectMatch);
