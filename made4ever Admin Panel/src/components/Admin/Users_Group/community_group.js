...
function CommunityGroup() {
  ...
  const onDelete = async (row) => {
    try {
      const confirmResult = await Swal.fire({
        title: "Are you sure?",
        text: "Do you really want to delete this Community Group?",
        icon: "warning",
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            ...
            text: "Community Group Deleted Successfully...",
  ...
  const rows = All_Community_Group?.map((doc, index) => ({
    id: doc._id || index,
    ...doc,
  }));
  ...
  const add_community_group = async () => {
    try {
      setloading(true);
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            icon: "success",
            title: "Community Group Added",
            text: "Community Group Addedd Successfully...",
            showConfirmButton: true,
            customClass: {
              popup: "small-swal-popup",
              confirmButton: "my-swal-button",
        ...
        <div className="content-wrapper">
          <div className="main-content">
            <div className="profile-header">
              <h3>Enter Details for Community Group Master</h3>
              <p>
                Add or update the required details for the community group master to
              ...
              <div className="form-grid">
                <FormControl fullWidth size="small">
                  ...
                  <TextField
                    ...
                    defaultValue={Community_Group.community_group}
