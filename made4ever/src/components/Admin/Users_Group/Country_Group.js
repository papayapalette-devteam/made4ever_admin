  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const column = [
        ...
        { field: 'parent_lookup_name', headerName: 'Country', flex: 0.5 }, 
        { field: 'city_code', headerName: 'Country Code', flex: 0.5 },
        { field: 'lookup_value', headerName: 'Status', flex: 0.5 },
       {
      field: 'actions',
      headerName: 'Actions',
      width: 80,
          ...
          const resp = await api.post("api/v1/admin/SaveLookup",
            {
              ...
              parent_lookup_id:Country_Group.country_code,
              other:{allergic_symptoms:Country_Group.status}
            }
          );
       ...
       <FormControl fullWidth size="small">
           ...
           <FormControl fullWidth size="small">
            ...
            <TextField 
              ...
              value={Country_Group.country_code}
              onChange={handlechange}
