  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const column = [
        ...
        { field: 'parent_lookup_name', headerName: 'Cast', flex: 0.5 },
        { field: 'lookup_value', headerName: 'Religion', flex: 0.5 },
       {
      field: 'actions',
      headerName: 'Actions',
      width: 80,
 ...
 <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  ...
                  <p>Add or update the required details for the cast group master to keep records accurate and complete.</p>
                  </div>
            ...
            <Select 
             ...
             MenuProps={{
                ...
                renderValue={(selected) => {
                  if (!selected) {
                    return <span style={{ color: "#9ca3af" }}>Religion Group</span>; // grey placeholder
                  }
