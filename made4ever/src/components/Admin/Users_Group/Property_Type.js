...
function PropertyType() {
  ...
  const rows = All_Property_Type?.map((doc, index) => ({
    id: doc._id || index,
    ...doc,
  }));
      ...
      if (resp.status === 200) {
        setTimeout(() => {
          Swal.fire({
            ...
            text: "Property Type Addedd Successfully...",
            showConfirmButton: true,
            customClass: {
              popup: "small-swal-popup",
              confirmButton: "my-swal-button",
        ...
        <div className="content-wrapper">
          <div className="main-content">
            <div className="profile-header">
              <h3>Enter Details for Property Type Master</h3>
              <p>
                Add or update the required details for the property type master
            ...
            <Paper elevation={3} sx={{ p: 2, borderRadius: 2 }}>
              ...
              <Button className="submit-button" onClick={add_property_type}>
                Submit
              </Button>
            </Paper>
