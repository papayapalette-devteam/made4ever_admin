  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const column = [
        ...
        { field: 'parent_lookup_name', headerName: 'State', flex: 0.5 }, 
        { field: 'city_code', headerName: 'State Code', flex: 0.5 },
        { field: 'lookup_value', headerName: 'Country', flex: 0.5 },
       {
      field: 'actions',
      headerName: 'Actions',
      width: 80,
          ...
          const resp = await api.post("api/v1/admin/SaveLookup",
            {
              ...
              parent_lookup_id:State_Group.state_code,
              other:{allergic_symptoms:State_Group.country_name}
            }
          );
 ...
 <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  ...
                  <p>Add or update the required details for the state group master to keep records accurate and complete.</p>
                  </div>
            ...
            <Select 
             ...
             MenuProps={{
                ...
                renderValue={(selected) => {
                  if (!selected) {
                    return <span style={{ color: "#9ca3af" }}>Country Name</span>; // grey placeholder
                  }
